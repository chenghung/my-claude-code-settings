...
assert_eq "classify done delay" "15"       "$(printf '%s' "$out" | cut -f3)"
...
assert_eq "classify auth delay" "90"       "$(printf '%s' "$out" | cut -f3)"
...
assert_eq "classify input delay" "45"      "$(printf '%s' "$out" | cut -f3)"
