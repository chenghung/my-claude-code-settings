...
# Every --antigravity invocation in this file goes through this helper so none
# of them can ever escape to the real agy binary.
AGY_STUB_LOG="$T/agy-stub.log"
: > "$AGY_STUB_LOG"
run_antigravity() {
  ( export PATH="$STUB_BIN:$PATH" AGY_STUB_LOG; "$REPO/install.sh" --antigravity --no-external > "$1" 2>&1 )
}

export GEMINI_HOME="$T/gemini"
run_antigravity "$T/log_ag1"
...
run_antigravity "$T/log_ag_gemini_conflict"
